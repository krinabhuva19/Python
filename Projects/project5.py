...
while True:
    ...
    match choice:
        case 1:
            ...
            eobj = Employee(id, name, age, salary)
            e_list.append(eobj)
        ...
        case 2:
            ...
            mobj = Manager(id, name, age, salary, dept)
            m_list.append(mobj)
        ...
        case 3:
            ...
            dobj = Developer(id, name, age, salary, prog)
            d_list.append(dobj)

        case 4:
            ch = int(input("Enter 1=Employee, 2=Manager, 3=Developer: "))
